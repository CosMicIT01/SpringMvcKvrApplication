...
<head>
    ...
    <title>Edit Person Details Form</title>
...
<div class="generic-container">
    ...
    <%--@elvariable id="editPersonDetail" type="de.cosmicit.kvr.model.Person"--%>
    <form:form method="POST" modelAttribute="editPersonDetail" class="form-horizontal">
    ...
    <div class="row">
        <div class="form-actions floatRight">
            <input type="submit" value="Edit" class="btn btn-primary btn-sm"/> or <a href="<c:url value='/person/list' />">Cancel</a>
        </div>
    </div>
    </form:form>
